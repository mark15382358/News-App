...
A beautiful, fast, and modern **News Application** built with **Flutter** that delivers the latest headlines from around the world in real-time.
...
- Multiple News Categories (General, Business, Sports, Technology, Entertainment, Science, Health)  
- Search for any topic or keyword  
- Save favorite articles (Bookmark)  
- Pull-to-refresh  
- Clean & Responsive UI  
- Light Mode Support  
...
- Maintains high-quality **Clean Code** standards  
- Efficient and optimized **API Integration**  
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/mark15382358/News-App.git
   cd News-App
